...
export const DATE_PERIODS = [
	...
	{ label: __("Last 3 Days Orders (excluding today)", TEXT_DOMAIN), value: "last-3-days" },
	{ label: __("Last 7 Days Orders (excluding today)", TEXT_DOMAIN), value: "last-7-days" },
	{ label: __("Last 14 Days Orders (excluding today)", TEXT_DOMAIN), value: "last-14-days" },
	{ label: __("Last 30 Days Orders (excluding today)", TEXT_DOMAIN), value: "last-30-days" },
	{ label: __("This Month Orders (including today)", TEXT_DOMAIN), value: "this-month" },
	{ label: __("Last Month Orders", TEXT_DOMAIN), value: "last-month" },
	{ label: __("Last 3 Months Orders (excluding current month)", TEXT_DOMAIN), value: "last-3-months" },
	{ label: __("Last 6 Months Orders (excluding current month)", TEXT_DOMAIN), value: "last-6-months" },
	{ label: __("Last 12 Months Orders (excluding current month)", TEXT_DOMAIN), value: "last-12-months" },
